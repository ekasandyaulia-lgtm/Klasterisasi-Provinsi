...
# Header Navigasi
col_logo, col_menu = st.columns([2, 8], gap="small")
 
with col_logo:
    st.markdown(
        """
        <div style="background-color:#0B0E14; height:52px; display:flex; align-items:center;
                    padding:0 18px; border-radius:10px 0 0 10px;">
            <span style="color:#00B871; font-size:20px; font-weight:800;">◆</span>
            <span style="color:#FFFFFF; font-size:18px; font-weight:800; margin-left:8px; letter-spacing:0.3px;">
                Klaster<span style="color:#00B871;">Provinsi</span>
            </span>
        </div>
        """,
...
with col_menu:
    halaman = option_menu(
        ...
        styles={
            ...
            "icon": {"color": "#B7BCC7", "font-size": "13px"},
            "nav-link": {
                "font-size": "13.5px",
                "color": "#B7BCC7",
                "font-weight": "600",
