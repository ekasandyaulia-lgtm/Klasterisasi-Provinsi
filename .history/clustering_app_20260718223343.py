...
# Heatmap Centroid
    ...
    # 1. Baca data yang sudah distandarisasi (agar angkanya seperti di Python)
    df_centroids = pd.read_csv("centroids_cluster.csv")
    
    # 2. Beri nama label index
    label_mapping = {
        0: 'Digital Menengah',
        1: 'Digital Maju',
    ...
    # 4. Buat visualisasi Plotly mirip Seaborn
    ...
    # Memaksa teks sumbu X lurus (tidak miring)
