...
# Halaman Dinamika Temporal
    ...
    try:
        ...
        unique_sources = sorted(list(sankey_counts['source'].unique()))
        unique_targets = sorted(list(sankey_counts['target'].unique()))
        labels = unique_sources + unique_targets
        ...
        fig_sankey = go.Figure(data=[go.Sankey(
            ...
            link=dict(
                source=sankey_counts['source_idx'], 
                target=sankey_counts['target_idx'], 
