...
@st.cache_data
def load_data():
    return pd.read_csv("hasil_clustering_final.csv"), pd.read_csv("metrics_results.csv")
...
# Halaman Dinamika Temporal
    ...
    try:
        ...
        palet_warna = {
            "Digital Maju": "#2ECC71",
            "Digital Menengah": "#F1C40F",
            "Digital Rendah": "#E74C3C",
            "Digital Spesialis Non-Tunai": "#3498DB",
        }
    ...
    with st.expander("Evaluasi Stabilitas Klaster per Tahun (Metodologi)", expanded=False):
        ...
        # Data metrik diekstrak dari hasil evaluasi notebook Python
        metrics_data = {
            'Tahun': [2021, 2022, 2023, 2024, 2025],
            'WCSS': [18.2045, 25.5276, 18.2128, 19.7207, 22.8123],
