...
if halaman == "Overview":
    ...
    if not df_tahun_lalu.empty and not df_tahun_ini.empty:
        ...
        if not df_merged.empty:
            persentase_naik = ((df_merged['Target_Semantic_now'] > df_merged['Target_Semantic_prev']).sum() / total_provinsi)
            persentase_turun = ((df_merged['Target_Semantic_now'] < df_merged['Target_Semantic_prev']).sum() / total_provinsi)
